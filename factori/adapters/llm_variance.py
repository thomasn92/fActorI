...
def build_llm_variance_prompt(
    *,
    ...
    prompt_text = (
        ...
        "negative_control. Treat family coverage as a hard batch-level contract: reserve one "
        "variant for benchmark or baseline_strengthening and a different variant for robustness "
        "or negative_control before assigning any remaining family. Do not use both required "
        "slots for benchmark and baseline_strengthening while omitting robustness and "
        "negative_control. Every variant needs a concrete "
